...
INSERT INTO products (
  ...
  (
    ...
    '{"Processor": "Apple M1 Chip (8-core CPU / 7-core GPU)", "RAM": "8GB Unified Memory", "Storage": "256GB SSD", "Display": "13.3 Retina Display", "OS": "macOS Sonoma"}'::jsonb,
    'Apple M1 · 8GB · 256GB SSD · 13.3" Retina',
    '["Best Seller", "MacBook", "Hot Deal"]'::jsonb,
    '1 Year Apple Warranty',
    '["Space Gray", "Silver", "Gold"]'::jsonb,
