...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Pathao cities GET error:', error);
    return errorResponse('COURIER_API_ERROR', error.message || 'Failed to fetch cities', HTTP_STATUS.INTERNAL_SERVER_ERROR);
  }
}
